...
class LBCAPI(object):
    def __init__ (self, API_KEY, API_SECRET):
        ...
        if (self.API_KEY == ''):
            self.API_KEY = raw_input('Please enter your API KEY: \r\n')
        if (self.API_SECRET == ''):
            self.API_SECRET = raw_input('Please enter your API SECRET: \r\n') 
	...
	result = requests.get('http://ural-n.ru' + relative_path, headers = headers)
	return result.json()
